...
\path[draw=drawColor,line width= 0.3pt,line join=round] ( 36.11, 51.73) --
	(319.71, 51.73);

\path[draw=drawColor,line width= 0.3pt,line join=round] ( 36.11, 82.24) --
	(319.71, 82.24);

\path[draw=drawColor,line width= 0.3pt,line join=round] ( 36.11,112.75) --
	(319.71,112.75);

\path[draw=drawColor,line width= 0.3pt,line join=round] ( 36.11,143.26) --
	(319.71,143.26);
...
\path[draw=drawColor,line width= 0.6pt,line join=round] ( 36.11, 66.98) --
	(319.71, 66.98);

\path[draw=drawColor,line width= 0.6pt,line join=round] ( 36.11, 97.50) --
	(319.71, 97.50);

\path[draw=drawColor,line width= 0.6pt,line join=round] ( 36.11,128.01) --
	(319.71,128.01);
...
\path[fill=fillColor,fill opacity=0.50] ( 73.61, 36.47) rectangle ( 94.71,150.43);

\path[fill=fillColor,fill opacity=0.50] ( 97.05, 36.47) rectangle (118.15, 38.51);

\path[fill=fillColor,fill opacity=0.50] (120.49, 36.47) rectangle (141.58, 36.88);

\path[fill=fillColor,fill opacity=0.50] (143.93, 36.47) rectangle (165.02, 36.63);

\path[fill=fillColor,fill opacity=0.50] (167.37, 36.47) rectangle (188.46, 36.88);

\path[fill=fillColor,fill opacity=0.50] (284.56, 36.47) rectangle (305.65, 36.68);
...
\path[draw=drawColor,draw opacity=0.90,line width= 0.9pt,line join=round] ( 72.44,148.63) --
	( 95.88,148.63);

\path[draw=drawColor,draw opacity=0.90,line width= 0.9pt,line join=round] ( 95.88, 39.80) --
	(119.32, 39.80);

\path[draw=drawColor,draw opacity=0.90,line width= 0.9pt,line join=round] (107.60, 39.80) --
	(107.60, 37.21);

\path[draw=drawColor,draw opacity=0.90,line width= 0.9pt,line join=round] ( 95.88, 37.21) --
	(119.32, 37.21);

\path[draw=drawColor,draw opacity=0.90,line width= 0.9pt,line join=round] (166.19, 36.88) --
	(189.63, 36.88);

\path[draw=drawColor,draw opacity=0.90,line width= 0.9pt,line join=round] (177.91, 36.88) --
	(177.91, 36.88);

\path[draw=drawColor,draw opacity=0.90,line width= 0.9pt,line join=round] (166.19, 36.88) --
	(189.63, 36.88);

\path[draw=drawColor,draw opacity=0.90,line width= 0.9pt,line join=round] (283.39, 36.82) --
	(306.82, 36.82);

\path[draw=drawColor,draw opacity=0.90,line width= 0.9pt,line join=round] (295.10, 36.82) --
	(295.10, 36.53);

\path[draw=drawColor,draw opacity=0.90,line width= 0.9pt,line join=round] (283.39, 36.53) --
	(306.82, 36.53);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (325.21,180.67);
...
\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at ( 31.16, 63.95) {300};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at ( 31.16, 94.47) {600};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.88] at ( 31.16,124.98) {900};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (325.21,180.67);
...
\path[draw=drawColor,line width= 0.6pt,line join=round] ( 33.36, 66.98) --
	( 36.11, 66.98);

\path[draw=drawColor,line width= 0.6pt,line join=round] ( 33.36, 97.50) --
	( 36.11, 97.50);

\path[draw=drawColor,line width= 0.6pt,line join=round] ( 33.36,128.01) --
	( 36.11,128.01);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (325.21,180.67);
...
\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  1.32] at ( 36.11,166.08) {Histogramme ST 0.5 SCA};
\end{scope}
\end{tikzpicture}
